...
function render_folders(folders) {
  localStorage.setItem("indexfolder", folders);
  ...
  <div class="col s12 m4 l3">
              ...
              <div class="my-card">
                ...
                <div class="bottom-layer valign-wrapper">
                  <a href="${folders[i]}.html" class="left">${folders[i]}</a>
...
function render_files(files, filetype) {
  localStorage.setItem("indexfile", files);
  localStorage.setItem("indexfiletypes", filetype);
...
var defaultfolders = ["Training"];
var defaultfiles = ["Public Holidays", "Portfolio"];
var defaultfiletype = ["DOC", "PDF"];

if (localStorage.getItem("indexfolder") === null) {
  localStorage.setItem("indexfolder", defaultfolders);
  localStorage.setItem("indexfile", defaultfiles);
  localStorage.setItem("indexfiletypes", defaultfiletype);
}

if (
  localStorage.getItem("indexfolder") !== "" &&
  localStorage.getItem("indexfolder") != "undefined"
) {
  var folders = localStorage.getItem("indexfolder").split(",");
} else {
  var folders = [];
}

if (
  localStorage.getItem("indexfile") !== "" &&
  localStorage.getItem("indexfile") != "undefined"
) {
  var files = localStorage.getItem("indexfile").split(",");
  var filetype = localStorage.getItem("indexfiletypes").split(",");
} else {
  var files = [];
  var filetype = [];
}
