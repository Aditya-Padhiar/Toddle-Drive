...
function render_folders(folders) {
  localStorage.setItem("trainingfolder", folders);
  ...
  <div class="col s12 m4 l3">
            <div class="my-card">
              ...
              <div class="bottom-layer valign-wrapper">
                <a href="${folders[i]}.html" class="left-align">${folders[i]}</a>
...
function render_files(files, filetype) {
  localStorage.setItem("trainingfile", files);
  localStorage.setItem("trainingfiletypes", filetype);
...
var defaultfiles = ["Training Schedule", "User Research"];
var defaultfiletype = ["DOC", "PDF"];

if (localStorage.getItem("trainingfolder") === null) {
  localStorage.setItem("trainingfolder", defaultfolders);
  localStorage.setItem("trainingfile", defaultfiles);
  localStorage.setItem("trainingfiletypes", defaultfiletype);
}

if (
  localStorage.getItem("trainingfolder") !== "" &&
  localStorage.getItem("trainingfolder") != "undefined"
) {
  var folders = localStorage.getItem("trainingfolder").split(",");
} else {
  var folders = [];
}

if (
  localStorage.getItem("trainingfile") !== "" &&
  localStorage.getItem("trainingfile") != "undefined"
) {
  var files = localStorage.getItem("trainingfile").split(",");
  var filetype = localStorage.getItem("trainingfiletypes").split(",");
} else {
  var files = [];
  var filetype = [];
}
